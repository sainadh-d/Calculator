...
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__37272 = o;
(G__37272[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__37423__i < G__37423__a.length) {G__37423__a[G__37423__i] = arguments[G__37423__i + 0]; ++G__37423__i;}
  args = new cljs.core.IndexedSeq(G__37423__a,0,null);
} 
return G__37418__delegate.call(this,args);};
G__37418.cljs$lang$maxFixedArity = 0;
G__37418.cljs$lang$applyTo = (function (arglist__37424){
var args = cljs.core.seq(arglist__37424);
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37299){
var map__37300 = p__37299;
var map__37300__$1 = cljs.core.__destructure_map(map__37300);
var props = map__37300__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37300__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37303){
var map__37304 = p__37303;
var map__37304__$1 = cljs.core.__destructure_map(map__37304);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37304__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__37321){
var map__37322 = p__37321;
var map__37322__$1 = cljs.core.__destructure_map(map__37322);
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37322__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37322__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__37324 = jsprops;
(G__37324["defaultValue"] = value);

(G__37324["onChange"] = (function (p1__37317_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__37317_SHARP_);
}));
...
var vec__37338 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37338,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37338,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37338,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37497 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37497 == null)){
} else {
var key_37499 = temp__5739__auto___37497;
(jsprops["key"] = key_37499);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__37358){
var map__37359 = p__37358;
var map__37359__$1 = cljs.core.__destructure_map(map__37359);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37359__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__37360 = reagent.impl.template.__GT_NativeWrapper();
(G__37360["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__37362 = wrapped;
(G__37362["syntheticInput"] = true);

return G__37362;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__37363 = wrapped__$1;
(G__37363["syntheticOnChange"] = on_change);

return G__37363;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__37364 = wrapped__$2;
(G__37364["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__4160__auto__ = synthetic_input;
...
var len__4771__auto___37603 = arguments.length;
var i__4772__auto___37604 = (0);
while(true){
if((i__4772__auto___37604 < len__4771__auto___37603)){
args__4777__auto__.push((arguments[i__4772__auto___37604]));

var G__37606 = (i__4772__auto___37604 + (1));
i__4772__auto___37604 = G__37606;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37372){
var G__37373 = cljs.core.first(seq37372);
var seq37372__$1 = cljs.core.next(seq37372);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37373,seq37372__$1);
}));
...
break;
default:
var G__37635 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__37635;
continue;
...
var n__4648__auto___37636 = a.length;
var i_37637 = (0);
while(true){
if((i_37637 < n__4648__auto___37636)){
(a[i_37637] = reagent.impl.template.as_element((a[i_37637])));

var G__37638 = (i_37637 + (1));
i_37637 = G__37638;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4648__auto___37639 = a.length;
var i_37640 = (0);
while(true){
if((i_37640 < n__4648__auto___37639)){
var val_37641 = (a[i_37640]);
if(((cljs.core.vector_QMARK_(val_37641)) && ((reagent.impl.template.key_from_vec(val_37641) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37640] = reagent.impl.template.as_element(val_37641));

var G__37642 = (i_37640 + (1));
i_37640 = G__37642;
continue;
} else {
}
...
var ctx = ({});
var vec__37396 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37396,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37396,(1),null);
...
var G__37402 = (cljs.core.count(argv) - first_child);
switch (G__37402) {
case (0):
