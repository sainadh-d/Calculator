...
var len__4771__auto___27409 = arguments.length;
var i__4772__auto___27410 = (0);
while(true){
if((i__4772__auto___27410 < len__4771__auto___27409)){
args__4777__auto__.push((arguments[i__4772__auto___27410]));

var G__27411 = (i__4772__auto___27410 + (1));
i__4772__auto___27410 = G__27411;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27338){
var G__27339 = cljs.core.first(seq27338);
var seq27338__$1 = cljs.core.next(seq27338);
var G__27340 = cljs.core.first(seq27338__$1);
var seq27338__$2 = cljs.core.next(seq27338__$1);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27339,G__27340,seq27338__$2);
}));
...
if(cljs.core.truth_((function (){var or__4160__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4160__auto__){
...
return cljs.core._write(writer__4405__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_(((cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group)))?(function (){var or__4160__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27349_SHARP_){
return (!((cljs.core.meta(p1__27349_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27358__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27361){var _e__26192__auto__ = e27361;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e27388){var _e__26192__auto__ = e27388;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27390 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27391 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27391);

try{var map__27394 = opts;
var map__27394__$1 = cljs.core.__destructure_map(map__27394);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27394__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27390);
}});
...
var temp__5733__auto___27429 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27429)){
var managed_print_level_27430 = temp__5733__auto___27429;
var _STAR_print_level_STAR__orig_val__27399_27431 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27400_27432 = managed_print_level_27430;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27400_27432);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27397_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27397_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27399_27431);
}} else {
job_fn();
}
