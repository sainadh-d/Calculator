...
var vec__36444 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
var seq__36445 = cljs.core.seq(vec__36444);
var first__36446 = cljs.core.first(seq__36445);
var seq__36445__$1 = cljs.core.next(seq__36445);
var start = first__36446;
var parts = seq__36445__$1;
...
var n = (function (){var or__4160__auto__ = ((cljs.core.fn_QMARK_(f))?(function (){var or__4160__auto__ = (f["displayName"]);
...
var or__4160__auto____$1 = (((((!((f == null))))?(((((f.cljs$lang$protocol_mask$partition1$ & (4096))) || ((cljs.core.PROTOCOL_SENTINEL === f.cljs$core$INamed$))))?true:false):false))?cljs.core.name(f):false);
...
(reagent.impl.util.PartialFn.prototype.call = (function (unused__9510__auto__){
var self__ = this;
var self__ = this;
var G__36466 = (arguments.length - (1));
switch (G__36466) {
case (0):
...
return cljs.core._write(writer__4405__auto__,"reagent.impl.util/PartialFn");
}));
...
var _STAR_always_update_STAR__orig_val__36503 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__36504 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__36504);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__36503);
}} else {
