...
var reader = (function (){var or__4160__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4160__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return (128);
...
var map__27315 = top_item;
var map__27315__$1 = cljs.core.__destructure_map(map__27315);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27315__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27315__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27315__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e27314){var _e = e27314;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___27334 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___27334)){
var seen_errors_27335 = temp__5733__auto___27334;
if(cljs.core.truth_(seen_errors_27335.has(self))){
} else {
seen_errors_27335.add(self);

var temp__5735__auto___27336 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___27336)){
var sense_27337 = temp__5735__auto___27336;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27337)].join(''));
} else {
}
}
} else {
